  ...
  ui: {
    ...
    featuredImage: {
      ...
      defaults: [
        ...
        'https://images.pexels.com/photos/257897/pexels-photo-257897.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    cta: {
      mainPage: {
        ...
        description: "Explore more of our content about social media growth and video editing techniques.",
        primaryButton: { text: "Visit Homepage", url: "/" },
        secondaryButton: { text: "More Articles", url: "/blog/" },
      },
      sidebar: {
        title: "About This Blog",
        description: "Welcome to the FeedMarketer blog where we share valuable tips and tutorials for TikTok, Instagram, and video editing.",
        primaryButton: { text: "Visit Homepage", url: "/" },
